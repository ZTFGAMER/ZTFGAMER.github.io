...
const LAYOUT_POSITION_KEYS = [
  ...
  'itemTierStarOffsetX',
  'itemTierStarOffsetY',
  'battleEnemyTierStarOffsetX',
  'battleEnemyTierStarOffsetY',
  'battlePlayerTierStarOffsetX',
  'battlePlayerTierStarOffsetY',
  'itemInfoWidth',
  'itemInfoMinH',
  'itemInfoMinHSmall',
]
...
const BATTLE_VFX_KEYS = [
  ...
  'battleCooldownOverlayAlpha',
  'battleCooldownProgressLineColor',
  'battleCooldownProgressLineHeight',
  'battleCooldownProgressLineAlpha',
  'battleCooldownProgressLineGlowHeight',
  'battleCooldownProgressLineGlowAlpha',
  ...
  'battlePlayerPortraitFourHeroEnabled',
  'battlePlayerPortraitFourHeroScale',
  'battlePlayerPortraitFourHeroSpacingPx',
  'battlePlayerPortraitFourHeroFrontOffsetX',
  'battlePlayerPortraitFourHeroFrontOffsetY',
  'battlePlayerPortraitFourHeroFrontScale',
  'battlePlayerPortraitFourHeroBack1OffsetX',
  'battlePlayerPortraitFourHeroBack1OffsetY',
  'battlePlayerPortraitFourHeroBack1Scale',
  'battlePlayerPortraitFourHeroBack2OffsetX',
  'battlePlayerPortraitFourHeroBack2OffsetY',
  'battlePlayerPortraitFourHeroBack2Scale',
  'battlePlayerPortraitFourHeroBack3OffsetX',
  'battlePlayerPortraitFourHeroBack3OffsetY',
  'battlePlayerPortraitFourHeroBack3Scale',
...
const GAMEPLAY_CHECKBOX_KEYS = [
  ...
  'gameplayShowItemDamageShieldOnIcon',
