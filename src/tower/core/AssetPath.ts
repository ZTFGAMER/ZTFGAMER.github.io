import { getAllItemsRaw } from '@/tower/core/DataLoader'
import { getSkillIconStemById, isSkillItemDefId } from '@/tower/common/skills/SkillItemDefs'
...
export function getTowerBattleImageUrl(fileName: string): string {
  return `${getResourceBasePath()}/towerbattle/${fileName}`
}
