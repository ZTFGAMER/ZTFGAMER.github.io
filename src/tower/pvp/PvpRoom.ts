...
import { WsConnection, type VirtualDataConnection } from '@/tower/pvp/WsConnection'
import type { PvpPlayer, PvpMsgToClient, PvpMsgToHost, PvpMode } from '@/tower/pvp/PvpTypes'
import { getOpponentFromAlive } from '@/tower/pvp/PvpTypes'
import type { BattleSnapshotBundle } from '@/tower/battle/BattleSnapshotStore'
import { getConfig } from '@/tower/core/DataLoader'
import { CombatEngine } from '@/tower/battle/CombatEngine'
