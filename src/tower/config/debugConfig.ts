import projectDebugDefaults from '../../../data/tower_debug_defaults.json'

// ============================================================
// debugConfig — 可运行时调整的调试参数
// 存储：localStorage（key 前缀 bigbazzar_tower_cfg_）
// 实时同步：BroadcastChannel（bigbazzar_tower_debug）
//
// 游戏侧：调用 getConfig() / 订阅 onConfigChange()
// 调试页侧：调用 setConfig() 即可同步到正在运行的游戏
// ============================================================

const STORAGE_PREFIX = 'bigbazzar_tower_cfg_'
const BC_NAME        = 'bigbazzar_tower_debug'
...
export const CONFIG_DEFS: Record<string, ConfigDef> = {
  ...
  battleCooldownProgressLineColor: {
    labelCn:      'CD进度线颜色',
    description:  '战斗中CD进度边界亮线颜色（16进制）',
    defaultValue: 0x8ec5ff,
    min:  0x000000,
    max:  0xffffff,
    step: 1,
    unit: 'hex',
  ...
  battleCooldownProgressLineGlowAlpha: {
    labelCn:      'CD进度线辉光透明度',
    description:  '战斗中CD进度边界亮线外圈辉光透明度',
    defaultValue: 0.45,
    min:  0,
    max:  1,
    step: 0.01,
  ...
  battleItemValueTweenMs: {
    labelCn:      '数值过渡时长',
    description:  '战斗中物品数值变化到目标值的过渡时长',
    defaultValue: 200,
    min:  10,
    max:  1000,
    step: 10,
  ...
  battleItemValuePulseDownMs: {
    labelCn:      '数值回弹时长',
    description:  '战斗中数值框从峰值回到原始大小的时长',
    defaultValue: 100,
    min:  10,
    max:  1000,
    step: 10,
  ...
  battleItemValuePulsePeakScale: {
    labelCn:      '数值峰值缩放',
    description:  '战斗中数值框放大峰值倍率（1.1=110%）',
    defaultValue: 1.1,
    min:  1,
    max:  2,
    step: 0.01,
  ...
  battlePlayerPortraitFourHeroEnabled: {
    labelCn:      '我方4英雄立绘开关',
    description:  '开启后底部展示 mage/archer/assassin/warrior 四立绘，关闭回到单英雄立绘',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack1OffsetX: {
    labelCn:      '4英雄-后方英雄1X偏移',
    description:  '四英雄模式下后方英雄1立绘的X偏移',
    defaultValue: 0,
    min:  -600,
    max:  600,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack1OffsetY: {
    labelCn:      '4英雄-后方英雄1Y偏移',
    description:  '四英雄模式下后方英雄1立绘的Y偏移',
    defaultValue: 0,
    min:  -300,
    max:  300,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack2OffsetX: {
    labelCn:      '4英雄-后方英雄2X偏移',
    description:  '四英雄模式下后方英雄2立绘的X偏移',
    defaultValue: 0,
    min:  -600,
    max:  600,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack2OffsetY: {
    labelCn:      '4英雄-后方英雄2Y偏移',
    description:  '四英雄模式下后方英雄2立绘的Y偏移',
    defaultValue: 0,
    min:  -300,
    max:  300,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack3OffsetX: {
    labelCn:      '4英雄-后方英雄3X偏移',
    description:  '四英雄模式下后方英雄3立绘的X偏移',
    defaultValue: 0,
    min:  -600,
    max:  600,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBack3OffsetY: {
    labelCn:      '4英雄-后方英雄3Y偏移',
    description:  '四英雄模式下后方英雄3立绘的Y偏移',
    defaultValue: 0,
    min:  -300,
    max:  300,
    step: 1,
  ...
  battlePlayerPortraitFourHeroBackDarken: {
    labelCn:      '4英雄-后排压暗',
    description:  '四英雄模式下后排三个英雄的压暗强度（0=不压暗,1=全黑）',
    defaultValue: 0.32,
    min:  0,
    max:  1,
    step: 0.01,
  ...
  gameplayBackpackRowsDynamicByDay: {
    labelCn:      '背包行数按天动态',
    description:  '1=true Day1-2=1行, Day3-5=2行, Day6+=3行；并联动战斗区Y与战斗场景Y偏移',
    defaultValue: 1,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayBackpackCols: {
    labelCn:      '背包列数',
    description:  '背包区总列数（修改后下次进入商店场景生效）',
    defaultValue: 6,
    min:  3,
    max:  6,
    step: 1,
  ...
  gameplayLevelRewardPreset: {
    labelCn:      '升级奖励开关',
    description:  '1=true 按奖励表发放；0=false 升级不发放任何奖励',
    defaultValue: 1,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayLevelQuickDraft: {
    labelCn:      '升级快捷三选一',
    description:  '1=true 升级时出现快捷三选一拖拽奖励；0=false 使用原升级奖励',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  levelQuickRewardOffsetX: {
    labelCn:      '奖励区相对战斗区X偏移',
    description:  '升级快捷奖励区相对于战斗区左上角的 X 偏移（正数向右）',
    defaultValue: 120,
    min:  -320,
    max:  420,
    step: 1,
  ...
  levelQuickRewardOffsetY: {
    labelCn:      '奖励区相对战斗区Y偏移',
    description:  '升级快捷奖励区相对于战斗区左上角的 Y 偏移（负数向上）',
    defaultValue: -360,
    min:  -900,
    max:  300,
    step: 1,
  ...
  gameplayShowTowerClassAttackDistance: {
    labelCn:      '塔防职业攻击距离线',
    description:  '1=塔防战斗显示战士/弓手/刺客攻击距离线；0=隐藏',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplaySameItemRandomSynthesis: {
    labelCn:      '同物品合成结果随机',
    description:  '0=同物品合成固定升级为本物品；1=升级后改为在“除本物品外”的全部物品中，按异物合成桶概率先抽品质再随机物品',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayItemSynthesisMaxLevel: {
    labelCn:      '物品合成最高等级',
    description:  '超过该等级不再允许合成升级；达到该等级的物品等级标签显示为 MAX',
    defaultValue: 4,
    min:  1,
    max:  8,
    step: 1,
  ...
  gameplayDefaultUpgradeHint: {
    labelCn:      '默认提示升级',
    description:  '1=商店中可升级物品左下角显示小向上箭头；0=不显示',
    defaultValue: 1,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayItemFrameColorByArchetype: {
    labelCn:      '物品框按职业着色',
    description:  '1=商店/战斗物品框按职业色显示，且职业+等级仅显示等级（中立不显示）；0=按品质色显示',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayShowClassName: {
    labelCn:      '显示职业名称',
    description:  '1=塔防物品角标显示“职业首字+等级”，且详情图标下方显示职业名；0=角标仅显示等级，详情隐藏职业名',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayShowItemDamageShieldOnIcon: {
    labelCn:      '物品图标显示伤害护盾',
    description:  '1=物品图标上显示伤害/护盾等数值徽标；0=隐藏这些数值徽标',
    defaultValue: 0,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayBaseBuyBronzeOnly: {
    labelCn:      '基础购买仅青铜',
    description:  '1=商店基础购买只会买到青铜级物品；0=按当前购买池品质购买',
    defaultValue: 1,
    min:  0,
    max:  1,
    step: 1,
  ...
  gameplayRunClassPoolBronzeCount: {
    labelCn:      '每职业青铜随机数',
    description:  '每局每个职业（战士/弓手/刺客）随机进入池子的青铜物品数量',
    defaultValue: 2,
    min:  0,
    max:  8,
    step: 1,
  ...
  gameplayRunClassPoolSilverCount: {
    labelCn:      '每职业白银随机数',
    description:  '每局每个职业（战士/弓手/刺客）随机进入池子的白银物品数量',
    defaultValue: 1,
    min:  0,
    max:  8,
    step: 1,
  ...
  gameplayRunClassPoolGoldCount: {
    labelCn:      '每职业黄金随机数',
    description:  '每局每个职业（战士/弓手/刺客）随机进入池子的黄金物品数量',
    defaultValue: 1,
    min:  0,
    max:  8,
    step: 1,
  ...
  gameplayRunClassPoolDiamondCount: {
    labelCn:      '每职业钻石随机数',
    description:  '每局每个职业（战士/弓手/刺客）随机进入池子的钻石物品数量',
    defaultValue: 1,
    min:  0,
    max:  8,
    step: 1,
  ...
  gameplayCompendiumBtnOffsetX: {
    labelCn:      '图鉴按钮偏移X',
    description:  '物品图鉴按钮相对玩家头像中心的X偏移（正数向右）',
    defaultValue: 0,
    min:  -320,
    max:  320,
    step: 1,
  ...
  gameplayCompendiumBtnOffsetY: {
    labelCn:      '图鉴按钮偏移Y',
    description:  '物品图鉴按钮相对玩家头像中心的Y偏移（负数向上）',
    defaultValue: -82,
    min:  -320,
    max:  320,
    step: 1,
  ...
  gameplayCompendiumPanelOffsetY: {
    labelCn:      '图鉴面板偏移Y',
    description:  '本局物品图鉴面板相对屏幕中心的Y偏移（正数向下）',
    defaultValue: 0,
    min:  -500,
    max:  700,
    step: 1,
  ...
  battleItemInfoCenterY: {
    labelCn:      '战斗物品详情面板 Y 坐标',
    description:  '战斗中点击物品后详情面板中心 Y 坐标',
    defaultValue: 728,
    min:  120,
    max:  1300,
    step: 2,
  ...
  shopPlayerStatusY: {
    labelCn:      '商店玩家信息 Y 偏移',
    description:  '非战斗玩家信息面板相对战斗区 Y 的偏移（正数向下）',
    defaultValue: -270,
    min:  -1200,
    max:  1200,
    step: 2,
  ...
  shopPlayerStatusX: {
    labelCn:      '商店玩家信息 X 偏移',
    description:  '非战斗玩家信息面板相对战斗区中心 X 的偏移（正数向右）',
    defaultValue: 0,
    min:  -320,
    max:  320,
    step: 1,
  ...
  itemInfoBottomGapToShop: {
    labelCn:      '详情面板相对战斗区Y偏移',
    description:  '商店物品详情/英雄详情/技能详情共享：面板底边 = 战斗区Y + 本偏移',
    defaultValue: -220,
    min:  -800,
    max:  400,
    step: 1,
  ...
  battleEnemyTierStarOffsetX: {
    labelCn:      '战斗敌方等级X偏移',
    description:  '仅战斗场景敌方生效：等级数字X附加偏移（负值左移，正值右移）',
    defaultValue: 0,
    min:  -64,
    max:  64,
    step: 1,
  ...
  battleEnemyTierStarOffsetY: {
    labelCn:      '战斗敌方等级Y偏移',
    description:  '仅战斗场景敌方生效：等级数字Y附加偏移（负值上移，正值下移）',
    defaultValue: 2,
    min:  -64,
    max:  64,
    step: 1,
  ...
  battlePlayerTierStarOffsetX: {
    labelCn:      '战斗我方等级X偏移',
    description:  '仅战斗场景我方生效：等级数字X附加偏移（负值左移，正值右移）',
    defaultValue: -2,
    min:  -64,
    max:  64,
    step: 1,
  ...
  battlePlayerTierStarOffsetY: {
    labelCn:      '战斗我方等级Y偏移',
    description:  '仅战斗场景我方生效：等级数字Y附加偏移（负值上移，正值下移）',
    defaultValue: -6,
    min:  -64,
    max:  64,
    step: 1,
  ...
  toastOffsetY: {
    labelCn:      'Toast Y偏移',
    description:  '商店 toast 相对屏幕中心的纵向偏移（正数向下）',
    defaultValue: 0,
    min:  -1000,
    max:  1000,
    step: 2,
  ...
  shopToastBg: {
    labelCn:      'Toast 背景色',
    description:  '商店 toast 提示框背景颜色',
    defaultValue: 0x0f1a2f,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  shopToastBorder: {
    labelCn:      'Toast 边框色',
    description:  '商店 toast 提示框边框颜色',
    defaultValue: 0xffe08a,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  shopGoldColor: {
    labelCn:      '金币颜色',
    description:  '商店内金币数值、金色文本颜色',
    defaultValue: 0xffd700,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  shopDangerColor: {
    labelCn:      '危险/警示颜色',
    description:  '商店内金币不足、错误状态等警示颜色',
    defaultValue: 0xff4444,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  shopHighlightColor: {
    labelCn:      '高亮颜色',
    description:  '合成高亮、选中状态等高亮颜色',
    defaultValue: 0xffcc44,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  classColorWarrior: {
    labelCn:      '战士职业颜色',
    description:  '战士职业标签、背景高亮颜色',
    defaultValue: 0xc54a4a,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  classColorArcher: {
    labelCn:      '弓手职业颜色',
    description:  '弓手职业标签、背景高亮颜色',
    defaultValue: 0x2c8b50,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  classColorAssassin: {
    labelCn:      '刺客职业颜色',
    description:  '刺客职业标签、背景高亮颜色',
    defaultValue: 0x3f5fb2,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  classColorMage: {
    labelCn:      '冰法师职业颜色',
    description:  '冰法师职业标签、背景高亮颜色',
    defaultValue: 0x9b6bff,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
  ...
  classColorNeutral: {
    labelCn:      '中立职业颜色',
    description:  '中立物品职业标签、背景高亮颜色',
    defaultValue: 0x8d6a2f,
    min:  0,
    max:  0xffffff,
    step: 1,
    unit: '',
