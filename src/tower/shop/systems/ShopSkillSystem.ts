...
import { getConfig, getAllItems } from '@/tower/core/DataLoader'
import { getConfig as getDebugCfg } from '@/tower/config/debugConfig'
import { normalizeSize, type ItemDef, type SkillArchetype, type SkillTier } from '@/tower/common/items/ItemDef'
...
import { BRONZE_SKILL_PICKS, getBronzeSkillById } from '@/tower/common/skills/BronzeSkillConfig'
import { SILVER_SKILL_PICKS, getSilverSkillById } from '@/tower/common/skills/SilverSkillConfig'
import { GOLD_SKILL_PICKS, getGoldSkillById } from '@/tower/common/skills/GoldSkillConfig'
import { getSkillPickById, isSkillItemDefId } from '@/tower/common/skills/SkillItemDefs'
import {
  parseTierName,
  toSkillArchetype,
  getPrimaryArchetype,
