...
import { getConfig, getAllItems, getAllItemsRaw } from '@/tower/core/DataLoader'
import { getWinTrophyState, getPlayerProgressState } from '@/tower/core/RunState'
...
import { resolveItemEnchantmentEffectCn } from '@/tower/common/items/ItemEnchantment'
...
function applyEnchantmentPreview(
  item: import('@/tower/common/items/ItemDef').ItemDef,
