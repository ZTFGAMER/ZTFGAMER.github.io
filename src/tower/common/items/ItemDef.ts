...
export interface GameConfig {
  ...
  towerDefenseRules?: {
    ...
    farAlpha: number
    nearScale: number
    opaqueWithinDistance?: number
    fullAlphaDistance?: number
    roadFarWidthRatio?: number
    ...
    projectileScaleMax?: number
    enemyDeathFlyAngleMinDeg?: number
    enemyDeathFlyAngleMaxDeg?: number
    enemyDeathFlySpeedMin?: number
    enemyDeathFlySpeedMax?: number
    enemyDeathFlyRotMinDegPerSec?: number
    enemyDeathFlyRotMaxDegPerSec?: number
    enemyDeathFlyOutMargin?: number
    enemyDeathFlyFadeStartMs?: number
    enemyDeathFlyFadeEndMs?: number
    enemyDeathFlyFinalAlpha?: number
    enemyDeathFlyScaleEndMs?: number
    enemyDeathFlyFinalScaleMul?: number
    enemyHitPopMs?: number
    enemyHitPopScale?: number
    reducedCooldownMinMs?: number
    moveDistancePerSecAtSpeed1: number
    playerItemAttackDistanceByIcon?: Record<string, number>
    ...
    playerMeleeSweepWeaponSizePx?: number
    playerMeleeSweepScaleBase?: number
    playerMeleeSweepScalePerDistance?: number
    playerMeleeSweepScaleDistanceUnit?: number
    playerMeleeSweepScaleMin?: number
