...
const BRONZE_DETAIL_DESC_BY_ID: Partial<Record<BronzeSkillId, string>> = {
  skill1: '战斗开始时，最左侧的护盾物品+30护盾。',
  skill2: '战斗开始时，最右侧的护盾物品+30护盾。',
  skill3: '战斗开始时，所有护盾物品+15护盾。',
  skill4: '使用护盾物品时，相邻物品伤害+4。',
  skill5: '使用护盾物品时该物品护盾+6。',
  skill6: '物品的间隔时间缩短5%。',
  skill7: '最大生命值增加10%。',
  skill8: '战斗开始时，最左侧的弹药物品+1最大弹药量。',
  skill9: '每场战斗首次弹药耗尽时，装填1发弹药。',
  skill10: '战斗开始时，拥有弹药的物品伤害+10。',
  skill11: '使用弹药物品时，相邻的弹药物品伤害+5。',
  skill12: '弹药物品的间隔时间缩短10%。',
  skill13: '每场战斗前5秒内，所有物品伤害+30。',
  skill14: '每场战斗前5秒内，所有物品间隔时间缩短20%。',
  skill15: '购买物品价格有25%几率减少1。',
  skill16: '战斗开始时，武器伤害+10。',
  skill18: '每场战斗敌人血量首次低于一半时，所有物品伤害+30。',
  skill19: '战斗开始时，最左侧和最右侧的武器伤害+18。',
