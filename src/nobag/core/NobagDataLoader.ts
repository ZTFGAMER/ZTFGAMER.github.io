...
import type { GameConfig, ItemDef } from '@/nobag/common/items/ItemDef'

// Vite 支持直接 import JSON（resolveJsonModule）
import rawConfig   from '../../../data/nobag_game_config.json'
import rawItems    from '../../../data/nobag_items.json'
import rawItemEnchantments from '../../../data/nobag_item_enchantments.json'
