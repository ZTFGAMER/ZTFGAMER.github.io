export const SHOP_STATE_STORAGE_KEY = 'bigbazzar_nobag_shop_state_v1'

const LIFE_STATE_STORAGE_KEY = 'bigbazzar_nobag_life_state_v1'
const LIFE_STATE_STORAGE_VERSION = 1
const DEFAULT_MAX_LIVES = 30
const TROPHY_STATE_STORAGE_KEY = 'bigbazzar_nobag_trophy_state_v1'
const TROPHY_STATE_STORAGE_VERSION = 1
const DEFAULT_WIN_TARGET = 10
const WIN_STREAK_STORAGE_KEY = 'bigbazzar_nobag_win_streak_v1'
const WIN_STREAK_STORAGE_VERSION = 1
const PLAYER_PROGRESS_STORAGE_KEY = 'bigbazzar_nobag_player_progress_v1'
const PLAYER_PROGRESS_STORAGE_VERSION = 1
const LAST_STAND_STATE_STORAGE_KEY = 'bigbazzar_nobag_last_stand_state_v1'
const LAST_STAND_STATE_STORAGE_VERSION = 1
const PLAYER_RUN_META_STORAGE_KEY = 'bigbazzar_nobag_player_run_meta_v1'
