...
import { getAllItems, getAllItemsRaw, getConfig as getGameConfig } from '@/nobag/core/NobagDataLoader'
import { getBuffIconUrl, getItemIconUrl, getUiImageUrl } from '@/nobag/core/NobagAssetPath'
import { getAllSkillItemDefs, getSkillItemDefById, isSkillItemDefId } from '@/nobag/common/skills/SkillItemDefs'
import { getClassColor, getTierColor } from '@/nobag/config/colorPalette'
import { getConfig as getDebugCfg } from '@/nobag/config/debugConfig'
import { getItemEnchantmentDisplay, type ItemEnchantmentKey } from '@/nobag/common/items/ItemEnchantment'
import {
  createItemStatBadges,
  type ItemBadgeDisplayMode,
  type ItemStatBadgeOverride,
} from '@/nobag/common/ui/ItemStatBadges'
