...
import { getAllItems } from '@/nobag/core/NobagDataLoader'
...
export function initPanelInstances(
  ...
  const neutralItemPanel = new NeutralItemPanel(ctx, stage, {
    ...
    toVisualTier: (tier, star) => toVisualTier(tier, star),
    instanceToDefId,
    setInstanceEnchantment: (instanceId, enchantment) => setInstanceEnchantment(instanceId, enchantment),
    getInstanceEnchantment: (instanceId) => getInstanceEnchantment(instanceId),
