...
import { clearBattleOutcome } from '@/nobag/battle/BattleOutcomeStore'
import { setBattleSnapshot } from '@/nobag/battle/BattleSnapshotStore'
...
import { getConfig as getDebugCfg, onConfigChange as onDebugCfgChange } from '@/nobag/config/debugConfig'
import { SellPopup } from '@/nobag/common/ui/SellPopup'
...
export function buildButtonRowUI(
  ...
  refreshBtn.container.visible = false
  ...
  sellBtn.container.visible = false
  ...
  phaseBtn.container.on('pointerdown', () => {
    if (!isShopInputEnabled(ctx)) { SceneManager.goto('nobag-shop'); return }
