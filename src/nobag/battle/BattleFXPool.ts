...
import { getBattleOrbColor } from '@/nobag/config/colorPalette'
import { getItemIconUrl, getItemIconUrlByName } from '@/nobag/core/NobagAssetPath'
import { getAllItemsRaw, getConfig as getGameCfg } from '@/nobag/core/NobagDataLoader'
import { CELL_SIZE, CELL_HEIGHT, type GridZone } from '@/nobag/common/grid/GridZone'
...
export class BattleFXPool {
  ...
  private updateZoneStatusFx(
    ...
    items: import('@/nobag/battle/CombatEngine').CombatBoardItem[],
